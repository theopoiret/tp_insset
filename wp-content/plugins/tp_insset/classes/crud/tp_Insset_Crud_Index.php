...
class tp_Insset_Crud_Index
{

    public function insert($table, $tab_valeur){
        global $wpdb;

        if($table == $wpdb->prefix.TP_INSSET_BASENAME."_utilisateurs"){
            $wpdb->insert(  $table, 
                            array(
                                'prenom' => $tab_valeur[0], 
                                'nom' => $tab_valeur[1], 
        ...
        if($table == $wpdb->prefix.TP_INSSET_BASENAME."_pays_effectuer"){
            $wpdb->insert(  $table, 
                            array(
            ...
            return " \nInsertion des pays effectuer par l'utilisateur ".$tab_valeur[0].": OK";
        }
